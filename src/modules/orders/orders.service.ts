      ...
      const itemsToInsert = safeOrderProduct.flatMap(
        (product) =>
          product.items?.map((item) => ({
            ...
            prodcod: product.prodcod,
            ordprodcod: product.ordprodcod, // Asignar el mismo ordprodcod que el producto padre
          })) ?? [],
      );
...
console.log('original productos',foundOrderProducts)
        console.log("Esta es la original", foundOrder)
        console.log("Esta es la duplicada", resDuplicateOrder)
